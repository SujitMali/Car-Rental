...
<html lang="en">
  ...
  <body>
    ...
    <div>
      ...
      <h2>Disapprove Owners Vehicles</h2>
      <table>
        <thead>
          <tr>
          	<th>#</th>
        		...
        		if(o.getOwnerCont()==v.getVehOwnerCont())
        		{
        			...
        			%>
        			 ...
        			 <td><%= i%></td>
			            ...
			            <td>detail</td>
			            <td style="text-align: center"><a href="company/approve/<%=v.getVehNo() %>/disapprove" ><button type="button" class="btn btn-primary" style="-bs-btn-padding-y: .25rem; - -bs-btn-padding-x: .5rem; - -bs-btn-font-size: .75rem;">
			                  Approve
			                </button></a>
			            </td>
			           			             <td style="text-align: center"><a href="company/delete/<%=v.getVehNo() %>/disapprove" ><button type="button" class="btn btn-primary" style="-bs-btn-padding-y: .25rem; - -bs-btn-padding-x: .5rem; - -bs-btn-font-size: .75rem;">
			                  Delete
			                </button></a>
			            </td>
