<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@ page import="com.byteBusters.dao.*" %>
...
<html lang="en">
  ...
  <body>
    ...
    <div>
      ...
      <h2>Pending Vehicles Bookings</h2>
      <table>
        <thead>
          <tr>
          	<th>#</th>
        ...
        <tbody>
        <%
        List<Booking> book = (List<Booking>) request.getAttribute("books");
        ...
        int i = 0;
        		...
        		for(Booking b : book)
        		{
                    ...
                    <td style="text-align: center"><a href="booking/approve/<%=b.getId() %>/pending" ><button type="button" class="btn btn-primary" style="-bs-btn-padding-y: .25rem; - -bs-btn-padding-x: .5rem; - -bs-btn-font-size: .75rem;">
                          Approve
                        </button></a>
                    </td>
                     <td style="text-align: center"><a href="booking/disapprove/<%=b.getId() %>/pending" ><button type="button" class="btn btn-primary" style="-bs-btn-padding-y: .25rem; - -bs-btn-padding-x: .5rem; - -bs-btn-font-size: .75rem;">
                          Disapprove
                        </button></a>
                    </td>
                     <td style="text-align: center"><a href="booking/delete/<%=b.getId() %>/pending" ><button type="button" class="btn btn-primary" style="-bs-btn-padding-y: .25rem; - -bs-btn-padding-x: .5rem; - -bs-btn-font-size: .75rem;">
                          Delete
                        </button></a>
                    </td>
