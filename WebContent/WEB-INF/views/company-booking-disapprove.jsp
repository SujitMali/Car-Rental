<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@ page import="com.byteBusters.model.Booking" %>
...
<html lang="en">
  ...
  <body>
    ...
    <div>
      ...
      <h2>Disapprove Vehicles Bookings</h2>
      <table>
        <thead>
          <tr>
          	<th>#</th>
        ...
        int i = 0;
        		...
        		for(Booking b : book)
        		{
                    ...
                    <td style="text-align: center"><a href="booking/approve/<%=b.getId() %>/disapprove" ><button type="button" class="btn btn-primary" style="-bs-btn-padding-y: .25rem; - -bs-btn-padding-x: .5rem; - -bs-btn-font-size: .75rem;">
                          Approve
                        </button></a>
                    </td>
                    
                     <td style="text-align: center"><a href="booking/delete/<%=b.getId() %>/disapprove" ><button type="button" class="btn btn-primary" style="-bs-btn-padding-y: .25rem; - -bs-btn-padding-x: .5rem; - -bs-btn-font-size: .75rem;">
                          Delete
                        </button></a>
                    </td>
