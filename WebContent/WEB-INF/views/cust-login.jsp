...
<body>
  ...
  <div class="login-container">
    <div class="container">
      ...
      <form action="afterCustomerLogin" method="post"> 
        <input type="text" id="contactNumber" name="custCont" placeholder="Contact Number" required>
        <input type="password" id="password" name="custPass" placeholder="Password" required>
    ...
    <div class="signup-link">
       <a href="cust-register">Don't have an account? Register</a>
    </div>
  </div>
