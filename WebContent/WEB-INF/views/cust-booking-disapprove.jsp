     ...
     <table>
        ...
        for(Booking b : book)
        {
            ...
            <td><%=b.getDate()%></td>
             ...
             <td style="text-align: center"><a href="booking/disapprove/<%=b.getId() %>" ><button type="button" class="btn btn-primary" style="-bs-btn-padding-y: .25rem; - -bs-btn-padding-x: .5rem; - -bs-btn-font-size: .75rem;">
                  Delete
                </button></a>
            </td>
