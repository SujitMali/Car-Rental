      ...
      <table>
        ...
        <tbody>
          <tr>
            ...
            <td style="text-align: center"><a href="" ><button type="button" class="btn btn-primary" style="-bs-btn-padding-y: .25rem; - -bs-btn-padding-x: .5rem; - -bs-btn-font-size: .75rem;">
                  Approve
                </button></a>
            </td>
             <td style="text-align: center"><a href="" ><button type="button" class="btn btn-primary" style="-bs-btn-padding-y: .25rem; - -bs-btn-padding-x: .5rem; - -bs-btn-font-size: .75rem;">
