...
function access(){
  alert('Choose location ');
    ...
    <body onload="access()">
         ...
         <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB9LZyb3LfiZTUjHI4yIb9T80OulXzA-mA&libraries=places"></script>
...
<!--       <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB9LZyb3LfiZTUjHI4yIb9T80OulXzA-mA&callback=myMap&libraries=places"></script> -->
