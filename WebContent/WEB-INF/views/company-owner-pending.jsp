...
<%@ page import="com.byteBusters.model.Owner" %>
    ...
    <div>
      ...
      <table>
        ...
        <% List<Owner> owner = (List<Owner> )request.getAttribute("owner"); 
            ...
            <td><%=o.getOwnerAge() %></td>
            <td style="text-align: center"><a href="owner/approve/<%=o.getOwnerCont() %>/pending" ><button type="button" class="btn btn-primary" style="-bs-btn-padding-y: .25rem; - -bs-btn-padding-x: .5rem; - -bs-btn-font-size: .75rem;">
                  Approve
                </button></a>
            </td>
             <td style="text-align: center"><a href="owner/disapprove/<%=o.getOwnerCont() %>/pending" ><button type="button" class="btn btn-primary" style="-bs-btn-padding-y: .25rem; - -bs-btn-padding-x: .5rem; - -bs-btn-font-size: .75rem;">
                  Disapprove
                </button></a>
            </td>
             <td style="text-align: center"><a href="owner/delete/<%=o.getOwnerCont() %>/pending" ><button type="button" class="btn btn-primary" style="-bs-btn-padding-y: .25rem; - -bs-btn-padding-x: .5rem; - -bs-btn-font-size: .75rem;">
                  Delete
                </button></a>
            </td>
