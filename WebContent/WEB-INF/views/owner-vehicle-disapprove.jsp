...
<html lang="en">
  ...
  <body>
    ...
    >
      <div class="container">
        <a class="navbar-brand" href="owner-home"
          ><span>Car</span>Owner</a
        >
        <button
      ...
      <table>
        ...
        for(Vehicle v : veh)
        {
            ...
            <td><%=v.getVehRenPrice()%></td>
             ...
             <td style="text-align: center"><a href="vehicle/delete/<%=v.getVehNo()%>/pending" ><button type="button" class="btn btn-primary" style="-bs-btn-padding-y: .25rem; - -bs-btn-padding-x: .5rem; - -bs-btn-font-size: .75rem;">
                  Delete
                </button></a>
            </td>
