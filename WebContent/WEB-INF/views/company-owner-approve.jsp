...
<html lang="en">
  ...
  <body>
    ...
    <div>
      ...
      <h2>Approved Vehicles Owners</h2>
      <table>
        <thead>
          <tr>
          	<th>#</th>
        ...
        <tbody>
         <% List<Owner> owner = (List<Owner> )request.getAttribute("owner"); 
            ...
            <td><%=o.getOwnerAge() %></td>
             ...
             <td style="text-align: center"><a href="owner/disapprove/<%=o.getOwnerCont() %>/approve" ><button type="button" class="btn btn-primary" style="-bs-btn-padding-y: .25rem; - -bs-btn-padding-x: .5rem; - -bs-btn-font-size: .75rem;">
                  Disapprove
                </button></a>
            </td>
