...
<html lang="en">
  ...
  <body>
    ...
    <!-- Table -->
    <div>
      <h2>Approve Vehicles Bookings</h2>
     <table>
        <thead>
          <tr>
          	<th>#</th>
        ...
        int i = 0;
        		...
        		for(Booking b : book)
        		{
                    ...
                    <td><%=b.getDate() %></td>
                     ...
                     <td style="text-align: center"><a href="booking/disapprove/<%=b.getId() %>/approve" ><button type="button" class="btn btn-primary" style="-bs-btn-padding-y: .25rem; - -bs-btn-padding-x: .5rem; - -bs-btn-font-size: .75rem;">
                          Disapprove
                        </button></a>
                    </td>
